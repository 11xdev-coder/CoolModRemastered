...
import java.util.function.Consumer; // For RecipeOutput replacement
...
public class IronFurnaceRecipeBuilder implements RecipeBuilder {
    ...
    @Override
    public RecipeBuilder unlockedBy(String name, CriterionTriggerInstance criterion) { // Changed from Criterion<?>
    ...
    public void save(Consumer<FinishedRecipe> pFinishedRecipeConsumer, ResourceLocation pRecipeId) {
        ...
        RecipeSerializer<?> serializer = ModRecipes.IronFurnaceSerializer.get(); // Ensure this serializer is correctly registered
